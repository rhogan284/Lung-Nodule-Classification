...
images = np.load('nodule_images_updated.npy')
labels = np.load('malignancy_scores_updated.npy')
...
print(nodule_images_equal.shape)
print(malignancy_scores_equal.shape)


np.save('nodule_images_updated_3', nodule_images_equal)
np.save('malignancy_scores_updated_3', malignancy_scores_equal)